= Turntable API for Scala

This is an incomplete version of the Turntable API as developed by Alain Gilbert (https://github.com/alaingilbert/Turntable-API).
It can (or will eventually) be useful for making bots on Turntable.
